...
class Provider
{
    ...
    {
        return bt()->filesystem()->exists($template)
    ...
    {
        $compiler = new BladeCompiler(bt()->filesystem(), bt()->config()->get('cache.path'));
        $resolver = new EngineResolver();
        $finder = new FileViewFinder(bt()->filesystem(), [bt()->config()->get('views.path')]);
